...
namespace Enemy
{
    public class EnemySpawner : MonoBehaviour
    {
        ...
        private Dictionary<EnemyNamespace.Enemy, int> enemyCounts; // Menyimpan jumlah musuh yang sudah muncul
        private Dictionary<EnemyNamespace.Enemy, List<GameObject>> activeEnemies; // Menyimpan referensi musuh yang aktif
        private int totalPossibleEnemies; // Menyimpan hasil penjumlahan totalMusuh dari setiap musuh dalam daftar

        void Start()
        {
            mainCamera = Camera.main;
            enemyCounts = new Dictionary<EnemyNamespace.Enemy, int>();
            activeEnemies = new Dictionary<EnemyNamespace.Enemy, List<GameObject>>();
        ...
        private IEnumerator ManageEnemySpawning(EnemyNamespace.Enemy enemy)
        {
        ...
        private void SpawnEnemy(EnemyNamespace.Enemy enemy)
        {
        ...
        private void OnEnemyDeath(EnemyNamespace.Enemy enemy, GameObject deadEnemy)
        {
